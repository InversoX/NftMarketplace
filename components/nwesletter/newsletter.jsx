	...
	return (
		<div>
			...
			<section
				...
				// style="background-image: url(img/nft-game/newsletter.png)"
				style={{
					backgroundImage: `url("/images/nft-game/newsletter.png")`,
				}}
			>
				<div className="container relative z-10">
					...
					<p className="mx-auto max-w-md text-center text-lg text-white">
						Be part of our amazing community and development updates, giveaways, launchapds, events.
