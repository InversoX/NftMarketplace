  ...
  const ProcessBlockContent = [
    {
      ...
      text: `Just simply press the connect button in order to be already inside your Inverso X account .`,
      icon: (
        <>
          <svg
    ...
    },
    {
      id: 2,
      step: "02",
      title: "Link your wallet account",
      text: `Once you've set up your wallet of choice, connect it to Inverso X and then choose the Trading Platform.`,
      icon: (
        <>
          <svg
            xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      ...
      text: `Now you're in, just trade and have fun. Simple as that.`,
      icon: (
        <>
          <svg
            xmlns="http://www.w3.org/2000/svg"
