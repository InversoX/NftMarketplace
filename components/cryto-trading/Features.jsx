  ...
  const featuresContent = [
    {
      ...
      text: `Add funds to your crypto account to start trading crypto. You can add funds with a variety of Wallets.`,
    },
    {
      id: 2,
      icon: (
    ...
    },
    {
      ...
      title: "Start trading",
      text: `Just simply trade and transfer your profits in your non custodial wallet.`,
    },
  ];
          ...
          <div className="lg:flex lg:flex-nowrap">
            ...
            <div className="mb-16 lg:w-1/2 lg:pl-5">
              <h2 className="mb-6 font-display text-3xl text-jacarta-700 dark:text-white">
                Grow your cryptocurrency portfolio anonimously today
              </h2>
